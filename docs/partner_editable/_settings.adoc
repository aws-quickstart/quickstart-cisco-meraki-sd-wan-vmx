...
:quickstart-project-name: quickstart-cisco-meraki-sd-wan-vmx
:partner-product-name: Cisco Meraki Virtual MX
...
:quickstart-contributors: Shivansh Singh, Muffadal Quettawala, AWS Quick Start team
